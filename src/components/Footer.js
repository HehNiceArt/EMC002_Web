    ...
    return(
        <div className="Footer-Container">
            ...
            <div className="Footer-Trademark">
                ...
                <p><Link to='PrivacyPolicy' className="Watermark">Privacy Policy</Link> | <Link to='TermsAndCondition' className="Watermark">Terms & Conditions</Link> | <Link to='/SafetyAndSecurity' className="Watermark">Safety & Security</Link> | <Link to='SupplierCodeofConduct' className="Watermark">Supplier Code Of Conduct</Link> | <Link to='CyberSecurity' className="Watermark">Cyber Security </Link><br></br>
 © 2024 Liminal Escapes Hotel Management Ltd. All Rights Reserved. ICP license: 17055189</p>
